...
model_run_name = 'multi_20_cl_fib_1-10'
BEAM_SIZE = 50
...
valid_dataset = nlp.load_dataset('bfp_dataset_script.py', split=nlp.Split.TEST)
...
df = pd.read_csv("/home/amharris/aug/bf_s_test.tsv",header=None,sep='\t')
