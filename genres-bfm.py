...
model_run_name = 'baseline_bfm_w_pretrain_20_cl_fib'
BEAM_SIZE = 50
...
def add_eos_to_examples(example):
    example['input_text'] = 'generate medium patch: %s </s>' % example['buggy']#.lower()
...
valid_dataset = nlp.load_dataset('bfp_medium_dataset_script.py', split=nlp.Split.TEST)
...
df = pd.read_csv("/home/amharris/aug/bf_m_test.tsv",header=None,sep='\t')
